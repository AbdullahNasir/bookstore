...
angular.module('bookStoreApp')
  .controller('BillPurchaseNewCtrl', function ($scope,customerFactory,publishers,books,setFactory,billFactory) {
        ...
        function validate(){
            ...
            if($scope.Bill.customer == {} || $scope.Bill.customer == undefined ){
                console.log($scope.Bill.customer);
                return false;
            }
        ...
        $scope.saveBill = function(){
            ...
            if(!validate()){
                alert("Bill save nahi kia ja sakta");
                return;
            }
            ...
            billFactory.newPurchaseBill(function(response){
                ...
                if(response.success){
                    ...
                    window.location = "#/bill/purchase/edit/"+response.billNo;
                }
                else{
